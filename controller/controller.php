...
define('__Secure_Key__', "EJbYQMwKZN");
...
switch($action){
   ...
   case "getResourcesCount" :
       getResourcesCount();
       break;    
   case "setPlanetforCategories" :
       setPlanetforCategories();
       break;    
}
...
{   
    if($_GET['secure_key'] == __Secure_Key__){
        ...
        $resourceClass->setCategoryResourceAssoc();
    }else{
        die('invalid secure key. RIP');
    }
    
}
function setPlanetforCategories()
{    
    $categoryClass = new Category();
    $categoryClass->setPlanetforCategories($_GET['id_parent']);
}
